...
#if defined(NDEBUG)
# error "Megcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Megcoin Signed Message:\n";
...
//TODO: this isn't identical to megcoin reference client.
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Megcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool ConnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // BIP16 was always active in Megcoin
...
{
    // Megcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
