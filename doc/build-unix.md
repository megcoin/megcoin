UNIX BUILD NOTES
====================
Some notes on how to build Megcoin in Unix. 
...
This will build megcoin-qt as well if the dependencies are met.
...
If you want to build Megcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a megcoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip megcoind" to strip the debug
